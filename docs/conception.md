...
<model-viewer id="viewer" alt="Modèle 3D de test" src="/images/Chassis.gltf" shadow-intensity="1" camera-controls touch-action="pan-y" style="width: 100%; height: 500px;">
</model-viewer>
