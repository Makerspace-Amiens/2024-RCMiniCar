...
<model-viewer id="viewer" alt="Modèle 3D du Chassis" src="/images/chassis3d.gltf" poster="/images/capture.jpg" shadow-intensity="1" camera-controls="" touch-action="pan-z" rotation="0 0 90" ar-status="not-presenting" data-dashlane-shadowhost="true" data-dashlane-observed="true"> </model-viewer>
